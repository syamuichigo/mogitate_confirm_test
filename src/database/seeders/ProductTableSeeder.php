...
class ProductTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $parm = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => '/src/storage/public/images/kiwi.png',
            'description' => 'キウイは甘みと酸味のバランスが絶妙なフルーツです。ビタミンCなどの栄養素も豊富のため、美肌効果や疲労回復効果も期待できます。もぎたてフルーツのスムージーをお召し上がりください！',
        ];
        DB::table('products')->insert($parm);
        $parm = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => '/src/storage/public/images/strawberry.png',
        ...
        $parm = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => '/src/storage/public/images/orenge.png',
        ...
        $parm = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => '/src/storage/public/images/watermelon.png',
        ...
        $parm = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => '/src/storage/public/images/peach.png',
        ...
        $parm = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => '/src/storage/public/images/muscat.png',
        ...
        $parm = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => '/src/storage/public/images/pineapple.png',
        ...
        $parm = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => '/src/storage/public/images/grapes.png',
        ...
        $parm = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => '/src/storage/public/images/banana.png',
        ...
        $parm = [
            'name' => 'メロン',
            'price' => 900,
            'image' => '/src/storage/public/images/melon.png',
